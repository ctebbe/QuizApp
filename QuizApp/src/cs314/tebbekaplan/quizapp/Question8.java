...
public class Question8 extends Activity {
	...
	protected void gotoPreviousQuestion(View v) {
		Intent intent = new Intent(v.getContext(), Question7.class);
	...
	protected void gotoNextQuestion(View v) {
		Intent intent = new Intent(v.getContext(), Question9.class);
		startActivityForResult(intent, 0);
	}
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.question8, menu);
        return true;
    }
}
